    ...
    public void saveActivity(ActivityLifeCycleEvent event) {
        ...
        if(!activity.getType().equals("SPACE_ACTIVITY")){
            if(activity.getType().equalsIgnoreCase("files:spaces")||activity.getType().equalsIgnoreCase("DOC_ACTIVITY")||activity.getType().equalsIgnoreCase("contents:spaces")){
                ...
                gamificationService.createHistory(GAMIFICATION_KNOWLEDGE_SHARE_UPLOAD__DOCUMENT_NETWORK_STREAM,activity.getPosterId(),activity.getPosterId(),"/portal/intranet/activity?id="+activity.getId());
     ...
     if (isSpaceActivity(activity)) {
         if(!activity.getType().equals("SPACE_ACTIVITY")) {
             ...
             gamificationService.createHistory(GAMIFICATION_SOCIAL_ADD_ACTIVITY_SPACE_STREAM,activity.getPosterId(),activity.getPosterId(),"/portal/intranet/activity?id=" + activity.getId());
             ...
             gamificationService.createHistory(GAMIFICATION_SOCIAL_ADD_ACTIVITY_SPACE_TARGET,activity.getPosterId(),spaceManager,"/portal/intranet/activity?id=" + activity.getId());
            ...
            if (activity.getPosterId().equalsIgnoreCase(activity.getStreamId())) {
                ...
                gamificationService.createHistory(GAMIFICATION_SOCIAL_ADD_ACTIVITY_MY_STREAM,activity.getPosterId(),activity.getStreamId(),"/portal/intranet/activity?id=" + activity.getId());

            } else { // User add an activity on his network's Stream


                //a user add an activity on the Stream of one of his network
                gamificationService.createHistory(GAMIFICATION_SOCIAL_ADD_ACTIVITY_TARGET_USER_STREAM,activity.getPosterId(),activity.getStreamId(),"/portal/intranet/activity?id=" + activity.getId());
...
//Waiting for spec to be implemented
    ...
    public void likeActivity(ActivityLifeCycleEvent event) {
        ...
        if (isSpaceActivity(activity)) {
            ...
            gamificationService.createHistory(GAMIFICATION_SOCIAL_LIKE_ACTIVITY_SPACE_STREAM,activity.getPosterId(),liker,"/portal/intranet/activity?id="+activity.getId()+"#comment-"+ ((ExoSocialActivityImpl) activity).getId());
            ...
            gamificationService.createHistory(GAMIFICATION_SOCIAL_LIKE_ACTIVITY_SPACE_TARGET, liker,activity.getPosterId(),"/portal/intranet/activity?id="+activity.getId());
            ...
            if (activity.getPosterId().equalsIgnoreCase(liker)) {
               return;
                ...
                gamificationService.createHistory(GAMIFICATION_SOCIAL_LIKE_ACTIVITY_NETWORK_STREAM,activity.getPosterId(),liker,"/portal/intranet/activity?id="+activity.getId()+"#comment-"+ ((ExoSocialActivityImpl) activity).getId());

                // Reward a user each time another user likes his activity
                gamificationService.createHistory(GAMIFICATION_SOCIAL_LIKE_ACTIVITY_TARGET_USER_STREAM, liker,activity.getPosterId(),"/portal/intranet/activity?id="+activity.getId()+"#comment-"+ ((ExoSocialActivityImpl) activity).getId());
            }
        }
    ...
    public void likeComment(ActivityLifeCycleEvent event) {
        ...
        if (isSpaceActivity(activity)) {
            gamificationService.createHistory(GAMIFICATION_SOCIAL_LIKE_COMMENT_SPACE_STREAM,liker,activity.getPosterId(),"/portal/intranet/activity?id="+activity.getParentId()+"#comment-"+ ((ExoSocialActivityImpl) activity).getId());
            ...
            if (activity.getPosterId().equalsIgnoreCase(activity.getStreamId())) {
             return;
                ...
                gamificationService.createHistory(GAMIFICATION_SOCIAL_LIKE_COMMENT_NETWORK_STREAM, activity.getPosterId(),liker,"/portal/intranet/activity?id="+activity.getParentId()+"#comment-"+ ((ExoSocialActivityImpl) activity).getId());
        ...
        // a user like a comment made by another user on the stream of other user
        gamificationService.createHistory(GAMIFICATION_SOCIAL_LIKE_COMMENT, liker,activity.getPosterId(),"/portal/intranet/activity?id="+activity.getParentId()+"#comment-"+ ((ExoSocialActivityImpl) activity).getId());
    }
